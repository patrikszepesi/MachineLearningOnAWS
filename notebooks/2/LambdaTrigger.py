...
#execute code from bash terminal
%%bash
...
#triggers in configuration in aws, timeout should be more than 3 seconds bc this takes a long time
#async invocation, with specified stuff, we said that it should run when new object gets uploaded to s3
import json
import urllib
